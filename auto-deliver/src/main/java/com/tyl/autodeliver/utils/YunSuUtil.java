...
public class YunSuUtil {
    ...
    public static String report(String username, String password, String softid, String softkey, String id) {
        ...
        String result;
        try {
            result = YunSuUtil.httpRequestData("http://api.ysdm.net/reporterror.xml",
                    param);
        } catch (IOException e) {
            result = "未知问题";
        }
    ...
    public static String createByPost(String username, String password,
        ...
        try {
            ...
            if (null != f) {
                ...
                if (data.length > 0) result = YunSuUtil.httpPostImage("http://api.ysdm.net/create.xml", param, data);
            }
        } catch (Exception e) {
            result = "未知问题";
        }
    ...
    public static String createByPost(String username, String password,
        ...
        String param = String
                .format(
                        ...
                        username, password, typeid, timeout, softid, softkey);
        try {
            result = YunSuUtil.httpPostImage("http://api.ysdm.net/create.xml", param, byteArr);
        } catch (Exception e) {
            result = "未知问题";
        }
